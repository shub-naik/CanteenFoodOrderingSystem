...
<div id='particles-js' style='background-color:red;box-sizing:border-box'>
<h1 style='text-align:center'>Admin Login Form</h1>
<div style='text-align:center'><button onclick="document.getElementById('id01').style.display='block'" style='width:auto'>Login</button></div>
